...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show active entries', function () {
			// TODO: Doit afficher les tâches en cours
		...
		it('should show completed entries', function () {
			// TODO: Doit afficher les tâches complétées
	...
	it('should highlight "All" filter by default', function () {
		// TODO: Doit surligner le filtre "All" par défaut
		setUpModel([]);
	...
	it('should highlight "Active" filter when switching to active view', function () {
		// TODO:  Doit surligner le filtre "Active" quand on passe sur la vue des taches actives
		setUpModel([]);
